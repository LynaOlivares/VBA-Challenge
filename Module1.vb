...
' Loop through sheets and Populate Summary Sections

For Each ws In Worksheets

    'Set Dimensions of workseeht and Initialize Variales
    ...
    'Summary 2 Output and Formatting
